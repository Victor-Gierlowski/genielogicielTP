...
class FizzBuzzTest(TestCase):
    ...
    def test_returns_number_for_input_divisible_by_3_not_5(self):
    ...
    def test_returns_number_input_divisible_by_5_not_3(self):
    ...
    def test_returns_number_input_divisible_by_5_and_3(self):
